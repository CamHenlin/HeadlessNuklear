...
var wasmBinaryFile = 'sample.wasm';
...
function flushCommandList(){ global.flushCommandList(); return; }
function pushCommandToOuterCommandList(currentCommand){ global.storeCommandOnCommandList(UTF8ToString(currentCommand)); return; }
function return_str(){ var jsString = global.test; var lengthBytes = jsString.length+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsString, stringOnWasmHeap, lengthBytes); global.test = ""; return stringOnWasmHeap; }
...
var asmLibraryArg = {
  ...
  "fd_write": _fd_write,
  "flushCommandList": flushCommandList,
  "pushCommandToOuterCommandList": pushCommandToOuterCommandList,
...
/** @type {function(...*):?} */
var _handleString = Module["_handleString"] = createExportWrapper("handleString");

/** @type {function(...*):?} */
var _EventLoop = Module["_EventLoop"] = createExportWrapper("EventLoop");
